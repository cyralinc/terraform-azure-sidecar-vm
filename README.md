...
| <a name="requirement_hashicorp_azurerm"></a> [hashicorp/azurerm](#requirement\_hashicorp\_azurerm) | >= 3.29.0 |

## Providers

| Name | Version |
|------|---------|
| <a name="providers_hashicorp_azurerm"></a> [hashicorp/azurerm](#providers\_hashicorp\_azurerm) | >= 3.29.0 |
...
| [azurerm_user_assigned_identity.user_assigned_identity](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/user_assigned_identity) | resource |
...
| [azurerm_role_definition.cyral-role_definition](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/role_definition) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_vm_username"></a> [vm\_username](#input\_vm\_username) | Virtual machine user name | `string` | `"ubuntu"` | yes |
...
| <a name="input_source_image_publisher"></a> [instance\_source\_image\_publisher](#input\_source\_image\_publisher) | Specifies the publisher of the image used to create the virtual machines | `string` | `"Canonical"` | no |
| <a name="input_source_image_offer"></a> [instance\_source\_image\_offer](#input\_source\_image\_offer) | Specifies the offer of the image used to create the virtual machines | `string` | `"0001-com-ubuntu-server-jammy"` | no |
...
| <a name="input_frontend_ip_config_name"></a> [frontend\_ip\_config\_name](#input\_frontend\_ip\_config\_name) | Load balance frontend ip configuration name | `string` | `"load_balance_frontend_ip"` | no |
